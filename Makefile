...
OBJECTS = Card.o Command.o Model/Player.o Model/HumanPlayer.o Model/ComputerPlayer.o Model/Deck.o Model/GameLogic.o Model/Table.o CardTestHarness.o View/View.o View/DeckGUI.o View/PlayerBox.o View/MenuBox.o View/HandBox.o View/PopupMessage.o View/CardTable.o Controller/Controller.o View/Observer.o Model/Subject.o
DEPENDS = ${OBJECTS:.o=.d}
EXEC = straights
